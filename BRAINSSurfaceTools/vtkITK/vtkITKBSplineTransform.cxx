...
public:
  ...
  virtual unsigned GetOrder() constexpr  = 0;

  virtual unsigned int GetNumberOfParameters() constexpr  = 0;
  ...
  virtual ParametersType constexpr & GetParameters() constexpr  = 0;

  virtual void SetFixedParameters( double constexpr *, unsigned N )  = 0;

  virtual constexpr double * GetFixedParameters( unsigned & N ) constexpr  = 0;
  ...
  virtual bool GetSwitchCoordinateSystem() constexpr  = 0;

  virtual void SetBulkTransform( constexpr double linear[3][3], constexpr double offset[3] )   = 0;

  virtual void GetBulkTransform( double linear[3][3], double offset[3] ) constexpr  = 0;
  virtual BulkTransformType constexpr * GetBulkTransform() constexpr  = 0;

  virtual itk::Transform<double, 3, 3>::Pointer GetITKTransform() constexpr  = 0;
};
